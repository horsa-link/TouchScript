...
namespace TouchScript
{
    ...
    public sealed class TouchManager : DebuggableMonoBehaviour
    {
        ...
        /// </summary>
        public static readonly Vector2 INVALID_POSITION = new(float.NaN, float.NaN);
        ...
        /// </summary>
        public FrameEvent OnFrameStart = new();

        /// <summary>
        /// Occurs when a frame is finished. After all other events.
        /// </summary>
        [SerializeField]
        public FrameEvent OnFrameFinish = new();

        /// <summary>
        /// Occurs when new hovering pointers are added.
        /// </summary>
        [SerializeField]
        public PointerEvent OnPointersAdd = new();

        /// <summary>
        /// Occurs when pointers are updated.
        /// </summary>
        [SerializeField]
        public PointerEvent OnPointersUpdate = new();

        /// <summary>
        /// Occurs when pointers touch the surface.
        /// </summary>
        [SerializeField]
        public PointerEvent OnPointersPress = new();

        /// <summary>
        /// Occurs when pointers are released.
        /// </summary>
        [SerializeField]
        public PointerEvent OnPointersRelease = new();

        /// <summary>
        /// Occurs when pointers are removed from the system.
        /// </summary>
        [SerializeField]
        public PointerEvent OnPointersRemove = new();

        /// <summary>
        /// Occurs when pointers are cancelled.
        /// </summary>
        [SerializeField]
        public PointerEvent OnPointersCancel = new();
