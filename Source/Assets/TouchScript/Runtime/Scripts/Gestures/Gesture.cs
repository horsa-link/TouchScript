...
namespace TouchScript.Gestures
{
    ...
    public abstract class Gesture : DebuggableMonoBehaviour
    {
		...
		/// Occurs when gesture changes state.
		/// </summary>
		public GestureEvent OnStateChange = new();
        ...
        /// </summary>
        protected List<Pointer> activePointers = new(10);
        ...
        private List<Gesture> friendlyGestures = new();
        ...
        private FakePointer fakePointer = new();
        ...
        public void RemoveFriendlyGesture(Gesture gesture)
        {
            INTERNAL_RemoveFriendlyGesture(gesture);
        }
        ...
        public virtual HitData GetScreenPositionHitData()
        {
            ...
            LayerManager.Instance.GetHitTarget(pointer, out var hit);
            return hit;
        }
        ...
        {
            cancelledInvoker?.InvokeHandleExceptions(this, EventArgs.Empty);
