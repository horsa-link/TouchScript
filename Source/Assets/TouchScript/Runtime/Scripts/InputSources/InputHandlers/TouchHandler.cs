...
namespace TouchScript.InputSources.InputHandlers
{
    ...
    public class TouchHandler : IInputSource, IDisposable
    {
        ...
        private Dictionary<int, TouchState> systemToInternalId = new(10);
        ...
        public TouchHandler(PointerDelegate addPointer, PointerDelegate updatePointer, PointerDelegate pressPointer, PointerDelegate releasePointer, PointerDelegate removePointer, PointerDelegate cancelPointer)
        {
            ...
            touchPool = new ObjectPool<TouchPointer>(10, () => new TouchPointer(this), null, resetPointer) {Name = "Touch"};
        ...
        protected virtual Touch GetTouch(int index) => Input.GetTouch(index);

        protected virtual int GetTouchCount() => Input.touchCount;
